...
public class RSP_Ranking extends JFrame {
	...
	ArrayList<RSP> arr1=new ArrayList<RSP>();
	...
	public RSP_Ranking() {
		...
		arr1.add(new RSP(NicknameCreate2.bb,RSP_Game.bb));
		
	
		
		JTextArea textArea = new JTextArea(arr1.toString().replace("[", "").replace("]", "").replace(",", ""));	// 유저 목록
